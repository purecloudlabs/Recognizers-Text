...
class NumberRecognizer(Recognizer[NumberOptions]):
    def __init__(
        self, target_culture: str = None, options: NumberOptions = NumberOptions.NONE, lazy_initialization: bool = True
    ):
    ...
    def initialize_configuration(self):
        ...
        self.register_model(
            ...
            Culture.German,
            lambda options: NumberModel(
                AgnosticNumberParserFactory.get_parser(ParserType.NUMBER, GermanNumberParserConfiguration()),
        ...
        self.register_model(
            ...
            Culture.German,
            lambda options: OrdinalModel(
                AgnosticNumberParserFactory.get_parser(ParserType.ORDINAL, GermanNumberParserConfiguration()),
        ...
        self.register_model(
            ...
            Culture.Dutch,
            lambda options: NumberModel(
                AgnosticNumberParserFactory.get_parser(ParserType.NUMBER, DutchNumberParserConfiguration()),
        ...
        self.register_model(
            ...
            Culture.Dutch,
            lambda options: OrdinalModel(
                AgnosticNumberParserFactory.get_parser(ParserType.ORDINAL, DutchNumberParserConfiguration()),
        ...
        self.register_model(
            ...
            Culture.Italian,
            lambda options: NumberModel(
                AgnosticNumberParserFactory.get_parser(ParserType.NUMBER, ItalianNumberParserConfiguration()),
        ...
        self.register_model(
            ...
            Culture.Italian,
            lambda options: OrdinalModel(
                AgnosticNumberParserFactory.get_parser(ParserType.ORDINAL, ItalianNumberParserConfiguration()),
        ...
        self.register_model(
            ...
            Culture.Catalan,
            lambda options: NumberModel(
                AgnosticNumberParserFactory.get_parser(ParserType.NUMBER, CatalanNumberParserConfiguration()),
        ...
        self.register_model(
            ...
            Culture.Catalan,
            lambda options: OrdinalModel(
                AgnosticNumberParserFactory.get_parser(ParserType.ORDINAL, CatalanNumberParserConfiguration()),
        ...
        self.register_model(
            ...
            Culture.Arabic,
            lambda options: NumberModel(
                AgnosticNumberParserFactory.get_parser(ParserType.NUMBER, ArabicNumberParserConfiguration()),
        ...
        self.register_model(
            ...
            Culture.Arabic,
            lambda options: OrdinalModel(
                AgnosticNumberParserFactory.get_parser(ParserType.ORDINAL, ArabicNumberParserConfiguration()),
...
def recognize_number(
    query: str, culture: str, options: NumberOptions = NumberOptions.NONE, fallback_to_default_culture: bool = True
) -> List[ModelResult]:
