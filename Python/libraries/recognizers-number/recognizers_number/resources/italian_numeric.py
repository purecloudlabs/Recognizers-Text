...
class ItalianNumeric:
    ...
    TensNumberIntegerRegex = '(vent(i|(?!\\b)|(?=\'))|(settant|trent|ottant|novant|quarant|cinquant|sessant)(a|(?!\\b)|(?=\')))'
    ...
    RoundNumberOrdinalRegex = '(centesim[oaie]|millesim[oaie]|milionesim[oaie]|miliardesim[oaie]|bilionesim[oaie]|trilionesim[oaie])'
    OneToNineOrdinalRegex = '(prim[oaie]|second[oaie]|terz[oaie]|quart[oaie]|quint[oaie]|sest[oaie]|settim[oaie]|ottav[oaie]|non[oaie])'
