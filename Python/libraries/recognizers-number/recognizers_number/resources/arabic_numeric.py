...
class ArabicNumeric:
    ...
    ArabicPartOfItem = '(?:أرباع|وربع|ارباع|واحد وربع|نصف|ربع|أنصاف|ربعين|أرباع|ارباع)'
