...
class NumberWithUnitRecognizer(Recognizer[NumberWithUnitOptions]):
    ...
    def initialize_configuration(self):
        ...
        self.register_model(
            'CurrencyModel',
            Culture.English,
            lambda options: CurrencyModel(
                [
                    ExtractorParserModel(
                        BaseMergedUnitExtractor(EnglishCurrencyExtractorConfiguration()),
        ...
        self.register_model(
            ...
            lambda options: CurrencyModel(
                [
                    ExtractorParserModel(
                        BaseMergedUnitExtractor(DutchCurrencyExtractorConfiguration()),
        ...
        self.register_model(
            ...
            lambda options: CurrencyModel(
                [
                    ExtractorParserModel(
                        BaseMergedUnitExtractor(FrenchCurrencyExtractorConfiguration()),
        ...
        self.register_model(
            ...
            lambda options: CurrencyModel(
                [
                    ExtractorParserModel(
                        BaseMergedUnitExtractor(SpanishCurrencyExtractorConfiguration()),
        ...
        self.register_model(
            ...
            lambda options: CurrencyModel(
                [
                    ExtractorParserModel(
                        BaseMergedUnitExtractor(ItalianCurrencyExtractorConfiguration()),
        ...
        self.register_model(
            ...
            lambda options: CurrencyModel(
                [
                    ExtractorParserModel(
                        BaseMergedUnitExtractor(GermanCurrencyExtractorConfiguration()),
        ...
        self.register_model(
            ...
            lambda options: CurrencyModel(
                [
                    ExtractorParserModel(
                        BaseMergedUnitExtractor(JapaneseCurrencyExtractorConfiguration()),
        ...
        self.register_model(
            ...
            lambda options: CurrencyModel(
                [
                    ExtractorParserModel(
                        BaseMergedUnitExtractor(CatalanCurrencyExtractorConfiguration()),
        ...
        self.register_model(
            ...
            lambda options: CurrencyModel(
                [
                    ExtractorParserModel(
                        BaseMergedUnitExtractor(ArabicCurrencyExtractorConfiguration()),
