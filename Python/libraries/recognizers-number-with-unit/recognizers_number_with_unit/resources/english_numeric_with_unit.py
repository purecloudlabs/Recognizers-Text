...
class EnglishNumericWithUnit:
    CurrencySuffixList = dict(
        [
            ...
            (
                "Mozambican metical",
                "mozambican metical|mt|mzn|mozambica metical|mozambica meticals|mozambican meticals",
            ),
            ...
            (
                ...
                "united states dollars|united states dollar|united states $|u.s. dollars|u.s. dollar|u s dollar|u s dollars|usd|american dollars|american dollar|us$|us dollar|us dollars|u.s dollar|u.s dollars|usd$",
            ),
            ...
            (
                "Liberian dollar",
                "liberian dollars|liberian dollar|liberian $|liberia dollars|liberia dollar|liberia $|lrd",
            ),
    ...
    CurrencyPrefixList = dict(
        [
            ...
            ("East Caribbean dollar", "east caribbean $|xcd"),
            ("Mexican peso", "mxn$|mxn $|mex$|mxn"),
            ("Australian dollar", "australian $|australia $|aud|aud$"),
            ("Bahamian dollar", "bahamian $|bahamia $|bsd"),
            ("Barbadian dollar", "barbadian $|barbadin $|bbd"),
            ("Belize dollar", "belize $|bzd"),
            ("Bermudian dollar", "bermudian $|bmd"),
            (
                "British Virgin Islands dollar",
                "british virgin islands $|bvi$|virgin islands $|virgin island $|british virgin island $",
            ),
            ("Brunei dollar", "brunei $|b$|bnd"),
            ("Sen", "sen"),
            ("Singapore dollar", "singapore $|s$|sgd"),
            ("Canadian dollar", "canadian $|can$|c$|c $|canada $|cad|cad$"),
            ("Cayman Islands dollar", "cayman islands $|ci$|cayman island $|kyd"),
            ("New Zealand dollar", "new zealand $|nz$|nz $|nzd|nzd$"),
            ("Cook Islands dollar", "cook islands $|cook island $"),
            ("Fijian dollar", "fijian $|fiji $|fjd"),
            ("Guyanese dollar", "gy$|gy $|g$|g $|gyd"),
            ("Hong Kong dollar", "hong kong $|hk$|hkd|hk $|hkd"),
            ("Indian rupee", "₹|inr"),
            ("Jamaican dollar", "jamaican $|j$|jamaica $|jmd"),
            ("Kiribati dollar", "kiribati $"),
            ("Liberian dollar", "liberian $|liberia $|lrd"),
            ("Micronesian dollar", "micronesian $"),
            ("Namibian dollar", "namibian $|nad|n$|namibia $|nad"),
            ("Nauruan dollar", "nauruan $"),
            ("Niue dollar", "niue $"),
            ("Palauan dollar", "palauan $"),
            ("Pitcairn Islands dollar", "pitcairn islands $|pitcairn island $"),
            ("Solomon Islands dollar", "solomon islands $|si$|si $|solomon island $|sbd"),
            ("Surinamese dollar", "surinamese $|surinam $|srd"),
            ("New Taiwan dollar", "nt$|nt $|ntd|twd"),
            ("Trinidad and Tobago dollar", "trinidad and tobago $|trinidad $|trinidadian $|ttd"),
    ...
    AmbiguityFiltersDict = dict(
        [
            ...
            (
                "^(all|bob|pen|cad|cup|cop|sos|ron|mad|mop|zar|gel)",
                "(all|bob|pen|cad|cup|cop|sos|ron|mad|mop|zar|gel)\\s*(\\d|\\p{L})",
            ),
            ("\\d\\s*pm\\b", "\\b(at|until|since|before|after)\\s\\d(\\d)?\\s*pm\\b"),
            (
                "\\bin\\b",
                "\\bin\\s*(\\d{4}|(jan|febr)uary|march|april|may|ju(ne|ly)|august|october|(sept|nov|dec)ember)",
            ),
            ...
            (
                "\\d\\s*c\\b",
                "(dividend (of|by) (\\d\\.)?\\d(\\d)?\\s*c|(\\d\\.)?\\d(\\d)?\\s*c/? (a share|per security))",
            ),
        ]
    )
