...
class ItalianNumericWithUnit:
    CurrencySuffixList = dict(
        [
            ...
            (
                "Costa Rican colón",
                "colón costaricano|crc|₡|colón del costa rica|colón del costarica|colon costaricano|colon del costa rica|colon del costarica",
            ),
            ...
            (
                "Mongolian tögrög",
                "tögrög mongolo|tögrög della mongolia|tögrög mongoli|mnt|₮|togrog mongolo|togrog della mongolia|togrog mongoli",
            ),
            ...
            (
                "Nicaraguan córdoba",
                "córdoba nicaraguense|córdoba nicaraguensi|cordoba nicaraguense|cordoba nicaraguensi|cordoba del nicaragua|nio",
            ),
            ("Nigerian naira", "naira nigeriano|naira nigeriani|naira della nigeria|naira|ngn|₦"),
            ("Kobo", "kobo"),
            (
                "Turkish lira",
                "lira turca|lire turche|nuova lira turca|nuove lire turche|lira della turchia|nuova lira della turchia|try|tl",
            ),
            ("Kuruş", "kuruş"),
            ...
            (
                "Paraguayan guaraní",
                "guaraní paraguaiano|guarani paraguaiano|guaraní paraguaiani|guarani paraguaiani|guaraní del paraguay|guarani del paraguay|₲|pyg",
            ),
            (
                "Peruvian sol",
                "sol peruviano|sol peruviani|sol del peru|soles|sol|nuevo sol peruviano|nuevo sol peruviani|nuevo sol del peru|",
            ),
            (
                "Polish złoty",
                "złoty|złoty polacco|złoty polacchi|zł|pln|zloty|zloty polacco|zloty polacchi|złoty della polonia",
            ),
            ...
            (
                "Samoan tālā",
                "tālā samoano|tālā samoani|tālā|tala|ws$|tālā di samoa|tala samoano|tala samoani|tala di samoa",
            ),
            ("Sene", "sene"),
            ...
            (
                "Netherlands guilder",
                "fiorino|fiorini|fiorino olandese|fiorini olandesi|fiorino delle antille olandesi|fiorini delle antille olandesi|ang",
            ),
            ...
            (
                "Venezuelan bolívar",
                "bolívar forte venezuelano|bolívar venezuelano|bolívar forte venezuelani|bolívar venezuelani|bs.f.|vef|bolívar fuerte|bolivar venezuelano|bolivar venezuelani",
            ),
            ...
            (
                "Somali shilling",
                "scellino somalo|scellini somali|scellino della somalia|scellini della somalia|sh.so.|sos",
            ),
            ("Somaliland shilling", "somaliland shillings|somaliland shilling|soomaaliland shilin"),
            (
                "Tanzanian shilling",
                "scellino tanzaniano|scellini tanzaniani|scellino della tanzania|scellini della tanzania|tsh|tzs",
            ),
            ("Ugandan shilling", "scellino ugandese|scellini ugandesi|scellino dell'uganda|scellini dell'uganda|ugx"),
            (
                "Romanian leu",
                "leu rumeno|leu rumeni|nuovo leu rumeno|leu della romania|nuovo leu della romania|lei|ron",
            ),
            ...
            (
                "Sri Lankan rupee",
                "rupia singalese|rupie singalesi|rupia dello sri lanka|rupie dello sri lanka|lkr|රු|ரூ",
            ),
            ...
            (
                "Uruguayan peso",
                "peso uruguaiano|peso uruguaiani|peso dell'uruguay|nuovo peso uruguaiano|nuovo peso uruguaiani|nuovo peso dell'uruguay|uyu",
            ),
            ("Peso", "pesos|peso"),
            ...
            (
                "British pound",
                "sterlina inglese|sterline inglesi|sterlina dell'inghilterra|sterlina del regno unito|british £|gbp",
            ),
            ...
            (
                ...
                "sterlina delle isole falkland|sterline delle isole falkland|falkland islands £|fkp",
            ),
            ...
            (
                ...
                "dollaro americano|dollari americani|dollaro statunitense|dollari statunitensi|dollaro degli stati uniti|dollari delgi stati uniti|u.s. dollars|u.s. dollar|u s dollar|u s dollars|usd|us$|us dollar|us dollars|u.s dollar|u.s dollars",
            ),
            (
                "East Caribbean dollar",
                "dollaro dei caraibi orientali|dollari dei caraibi orientali|east Caribbean $|xcd",
            ),
            (
                "Australian dollar",
                "dollaro australiano|dollari australiani|dollaro dell australia|australian $|australian$|aud",
            ),
            ...
            (
                "Canadian dollar",
                "dollaro canadese|dollari canadesi|dollaro del canada|canadian dollar|canadian $|cad|can$|c$|canada dollars|canada $",
            ),
            (
                "Cayman Islands dollar",
                "dollaro delle cayman|dollari delle cayman|dollaro delle isole cayman|dollari delle isole cayman|kyd|ci$",
            ),
            (
                "New Zealand dollar",
                "dollaro neozelandese|dollari neozelandesi|dollaro della nuova zelanda|new zealand $|nz$|nzd|kiwi",
            ),
            (
                "Cook Islands dollar",
                "cook islands dollars|cook islands dollar|cook islands $|cook island dollars|cook island dollar|cook island $|dollaro delle isole cook|dollari delle isole cook|dollaro delle cook|dollari delle cook|",
            ),
            ...
            (
                "Hong Kong dollar",
                "dollaro di hong kong|dollari di hong kong|hong kong $|hk$|hkd|hk dollars|hk dollar|hk $|hongkong$",
            ),
            (
                "Jamaican dollar",
                "dollaro giamaicano|dollari giamaicani| dollaro della giamaica|jamaican dollars|jamaican dollar|jamaican $|j$|jamaica dollars|jamaica dollar|jamaica $|jmd",
            ),
            ("Kiribati dollar", "kiribati dollars|kiribati dollar|kiribati $|dollaro di kiribati|dollari di kiribati"),
            (
                "Liberian dollar",
                "dollaro liberiano|dollari liberiano|dollaro liberia|liberian dollars|liberian dollar|liberian $|liberia dollars|liberia dollar|liberia $|lrd",
            ),
            ("Micronesian dollar", "micronesian dollars|micronesian dollar|micronesian $"),
            (
                "Namibian dollar",
                "dollaro di namibia|dollari di namibia|namibian dollar|namibian $|nad|n$|namibia dollars|namibia dollar|namibia $",
            ),
            ...
            (
                ...
                "dollaro delle salomone|dollari delle salomone|solomon islands dollars|solomon islands dollar|solomon islands $|si$|sbd|solomon island dollars|solomon island dollar|solomon island $",
            ),
            ("Surinamese dollar", "dollaro surinamese|dollari surinamese|surinamese dollar|surinamese $|srd"),
            (
                "New Taiwan dollar",
                "dollaro taiwanese|dollari taiwanesi|new taiwan dollars|new taiwan dollar|nt$|twd|ntd",
            ),
            (
                "Trinidad and Tobago dollar",
                "dollaro trinidad e tobago|dollari trinidad e tobago|trinidad and tobago dollars|trinidad and tobago dollar|trinidad and tobago $|trinidad $|trinidad dollar|trinidad dollars|trinidadian dollar|trinidadian dollars|trinidadian $|ttd",
            ),
            ...
            (
                "Finnish markka",
                "suomen markka|finnish markka|finsk mark|fim|markkaa|markka|marco finlandese|marchi finlandesi",
            ),
            ("Penni", "penniä|penni"),
    ...
    CompoundUnitConnectorRegex = '(?<spacer>e)'
