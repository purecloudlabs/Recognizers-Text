...
class EnglishDateTimeExtractorConfiguration(DateTimeExtractorConfiguration):
    ...
    def __init__(self, dmyDateFormat=False):
        super().__init__()
        self._date_point_extractor = BaseDateExtractor(EnglishDateExtractorConfiguration(dmyDateFormat))
        ...
        self._number_as_time_regex = RegExpUtility.get_safe_reg_exp(EnglishDateTime.NumberAsTimeRegex)
        self._date_number_connector_regex = RegExpUtility.get_safe_reg_exp(EnglishDateTime.DateNumberConnectorRegex)
        self._suffix_after_regex = RegExpUtility.get_safe_reg_exp(EnglishDateTime.SuffixAfterRegex)
        self._year_suffix = RegExpUtility.get_safe_reg_exp(EnglishDateTime.YearSuffix)
