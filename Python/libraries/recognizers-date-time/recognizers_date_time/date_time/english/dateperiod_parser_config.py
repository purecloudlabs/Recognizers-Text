...
class EnglishDatePeriodParserConfiguration(DatePeriodParserConfiguration):
    ...
    def __init__(self, config: BaseDateParserConfiguration):
        ...
        self._relative_regex = RegExpUtility.get_safe_reg_exp(EnglishDateTime.RelativeRegex)
        self._decade_with_century_regex = RegExpUtility.get_safe_reg_exp(EnglishDateTime.DecadeWithCenturyRegex)
        self._complex_dateperiod_regex = RegExpUtility.get_safe_reg_exp(EnglishDateTime.ComplexDatePeriodRegex)
        self._relative_decade_regex = RegExpUtility.get_safe_reg_exp(EnglishDateTime.RelativeDecadeRegex)
        self._reference_date_period_regex = RegExpUtility.get_safe_reg_exp(EnglishDateTime.ReferenceDatePeriodRegex)
