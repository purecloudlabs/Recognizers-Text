...
class GermanTimePeriodParserConfiguration(TimePeriodParserConfiguration):
    ...
    def __init__(self, config: BaseDateParserConfiguration):
        ...
        self._specific_time_from_to_regex = RegExpUtility.get_safe_reg_exp(GermanDateTime.SpecificTimeFromTo)
        self._specific_time_between_and_regex = RegExpUtility.get_safe_reg_exp(GermanDateTime.SpecificTimeBetweenAnd)
    ...
    def get_matched_timex_range(self, source: str) -> MatchedTimeRegex:
        ...
        if any(trimmed_text.endswith(o) for o in GermanDateTime.MorningTermList):
            ...
            source == GermanDateTime.DaytimeTermList[0]
            or source.endswith(GermanDateTime.DaytimeTermList[1])
