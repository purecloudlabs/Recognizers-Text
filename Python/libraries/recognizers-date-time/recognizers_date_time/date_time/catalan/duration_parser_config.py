...
class CatalanDurationParserConfiguration(DurationParserConfiguration):
    ...
    def __init__(self, config):
        ...
        self._unit_map: Dict[str, str] = CatalanDateTime.UnitMap
        self._unit_value_map: Dict[str, int] = CatalanDateTime.UnitValueMap
        self._double_numbers: Dict[str, float] = CatalanDateTime.DoubleNumbers
