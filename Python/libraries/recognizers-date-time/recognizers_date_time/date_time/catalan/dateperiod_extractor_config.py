...
from .common_configs import CatalanOrdinalExtractor, CatalanCardinalExtractor
...
class CatalanDatePeriodExtractorConfiguration(DatePeriodExtractorConfiguration):
    ...
    def __init__(self, dmyDateFormat=False):
        ...
        self._simple_cases_regexes = [
            ...
            RegExpUtility.get_safe_reg_exp(CatalanDateTime.BetweenRegex),
            RegExpUtility.get_safe_reg_exp(CatalanDateTime.OneWordPeriodRegex),
            RegExpUtility.get_safe_reg_exp(CatalanDateTime.MonthWithYear),
            RegExpUtility.get_safe_reg_exp(CatalanDateTime.MonthNumWithYear),
            RegExpUtility.get_safe_reg_exp(CatalanDateTime.YearRegex),
            RegExpUtility.get_safe_reg_exp(CatalanDateTime.DecadeWithCenturyRegex),
            ...
            RegExpUtility.get_safe_reg_exp(CatalanDateTime.AllHalfYearRegex),
            ...
            RegExpUtility.get_safe_reg_exp(CatalanDateTime.DecadeWithCenturyRegex),
            RegExpUtility.get_safe_reg_exp(CatalanDateTime.RelativeDecadeRegex),
        ...
        self._year_period_regex = RegExpUtility.get_safe_reg_exp(
            CatalanDateTime.YearPeriodRegex
        )
