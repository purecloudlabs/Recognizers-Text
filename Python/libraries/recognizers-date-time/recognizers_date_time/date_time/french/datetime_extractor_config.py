...
class FrenchDateTimeExtractorConfiguration(DateTimeExtractorConfiguration):
    ...
    def __init__(self):
        ...
        self._number_as_time_regex = RegExpUtility.get_safe_reg_exp(FrenchDateTime.NumberAsTimeRegex)
        self._date_number_connector_regex = RegExpUtility.get_safe_reg_exp(FrenchDateTime.DateNumberConnectorRegex)
        self._suffix_after_regex = RegExpUtility.get_safe_reg_exp(FrenchDateTime.SuffixAfterRegex)
        self._year_suffix = RegExpUtility.get_safe_reg_exp(FrenchDateTime.YearSuffix)
