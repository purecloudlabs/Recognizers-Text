...
class ArabicDateTimeExtractorConfiguration(DateTimeExtractorConfiguration):
    ...
    def __init__(self, dmyDateFormat=True):
        super().__init__()
        self._date_point_extractor = BaseDateExtractor(ArabicDateExtractorConfiguration())
        self._time_point_extractor = BaseTimeExtractor(ArabicTimeExtractorConfiguration())
        ...
        self.preposition_regex = RegExpUtility.get_safe_reg_exp(ArabicDateTime.PrepositionRegex)
        ...
        self._time_of_today_after_regex = RegExpUtility.get_safe_reg_exp(ArabicDateTime.TimeOfTodayAfterRegex)
        self._simple_time_of_today_after_regex = RegExpUtility.get_safe_reg_exp(
            ArabicDateTime.SimpleTimeOfTodayAfterRegex
        )
        self._night_regex = RegExpUtility.get_safe_reg_exp(ArabicDateTime.TimeOfDayRegex)
        self._time_of_today_before_regex = RegExpUtility.get_safe_reg_exp(ArabicDateTime.TimeOfTodayBeforeRegex)
        ...
        self.connector_regex = RegExpUtility.get_safe_reg_exp(ArabicDateTime.ConnectorRegex)
        self._number_as_time_regex = RegExpUtility.get_safe_reg_exp(ArabicDateTime.NumberAsTimeRegex)
        self._date_number_connector_regex = RegExpUtility.get_safe_reg_exp(ArabicDateTime.DateNumberConnectorRegex)
