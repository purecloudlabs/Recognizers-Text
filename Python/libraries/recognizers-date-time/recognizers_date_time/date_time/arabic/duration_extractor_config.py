...
class ArabicDurationExtractorConfiguration(DurationExtractorConfiguration):
    ...
    def __init__(self):
        ...
        self._all_regex: Pattern = RegExpUtility.get_safe_reg_exp(ArabicDateTime.AllRegex)
        self._half_regex: Pattern = RegExpUtility.get_safe_reg_exp(ArabicDateTime.HalfRegex)
        ...
        self._during_regex: Pattern = RegExpUtility.get_safe_reg_exp(ArabicDateTime.DuringRegex)
        ...
        self._duration_unit_regex = RegExpUtility.get_safe_reg_exp(ArabicDateTime.DurationUnitRegex)
        self._duration_connector_regex = RegExpUtility.get_safe_reg_exp(ArabicDateTime.DurationConnectorRegex)
        ...
        self._conjunction_regex = RegExpUtility.get_safe_reg_exp(ArabicDateTime.ConjunctionRegex)
        self._inexact_number_regex = RegExpUtility.get_safe_reg_exp(ArabicDateTime.InexactNumberRegex)
