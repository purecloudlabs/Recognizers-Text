...
class PortugueseDurationExtractorConfiguration(DurationExtractorConfiguration):
    ...
    def __init__(self):
        ...
        self._all_regex: Pattern = RegExpUtility.get_safe_reg_exp(PortugueseDateTime.AllRegex)
        self._half_regex: Pattern = RegExpUtility.get_safe_reg_exp(PortugueseDateTime.HalfRegex)
        ...
        self._during_regex: Pattern = RegExpUtility.get_safe_reg_exp(PortugueseDateTime.DuringRegex)
        ...
        self._duration_unit_regex = RegExpUtility.get_safe_reg_exp(PortugueseDateTime.DurationUnitRegex)
        self._duration_connector_regex = RegExpUtility.get_safe_reg_exp(PortugueseDateTime.DurationConnectorRegex)
        self._more_than_regex = RegExpUtility.get_safe_reg_exp(PortugueseDateTime.MoreThanRegex)
        self._less_than_regex = RegExpUtility.get_safe_reg_exp(PortugueseDateTime.LessThanRegex)
        self._conjunction_regex = RegExpUtility.get_safe_reg_exp(PortugueseDateTime.ConjunctionRegex)
        self._inexact_number_regex = RegExpUtility.get_safe_reg_exp(PortugueseDateTime.InexactNumberRegex)
