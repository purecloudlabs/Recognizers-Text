...
class PortugueseTimeExtractorConfiguration(TimeExtractorConfiguration):
    ...
    def __init__(self):
        super().__init__()
        self._desc_regex = RegExpUtility.get_safe_reg_exp(PortugueseDateTime.DescRegex)
        self._hour_num_regex = RegExpUtility.get_safe_reg_exp(PortugueseDateTime.HourNumRegex)
        self._minute_num_regex = RegExpUtility.get_safe_reg_exp(PortugueseDateTime.MinuteNumRegex)
        self._oclock_regex = RegExpUtility.get_safe_reg_exp(PortugueseDateTime.OclockRegex)
        self._pm_regex = RegExpUtility.get_safe_reg_exp(PortugueseDateTime.PmRegex)
        self._am_regex = RegExpUtility.get_safe_reg_exp(PortugueseDateTime.AmRegex)
        self._less_than_one_hour = RegExpUtility.get_safe_reg_exp(PortugueseDateTime.LessThanOneHour)
        self._written_time_regex = RegExpUtility.get_safe_reg_exp(PortugueseDateTime.WrittenTimeRegex)
        self._time_prefix = RegExpUtility.get_safe_reg_exp(PortugueseDateTime.TimePrefix)
        self._time_suffix = RegExpUtility.get_safe_reg_exp(PortugueseDateTime.TimeSuffix)
        self._basic_time = RegExpUtility.get_safe_reg_exp(PortugueseDateTime.BasicTime)
        self._midnight_regex = RegExpUtility.get_safe_reg_exp(PortugueseDateTime.MidnightRegex)
        self._midmorning_regex = RegExpUtility.get_safe_reg_exp(PortugueseDateTime.MidmorningRegex)
        self._midafternoon_regex = RegExpUtility.get_safe_reg_exp(PortugueseDateTime.MidafternoonRegex)
        self._midday_regex = RegExpUtility.get_safe_reg_exp(PortugueseDateTime.MiddayRegex)
        self._midtime_regex = RegExpUtility.get_safe_reg_exp(PortugueseDateTime.MidTimeRegex)
        ...
        self._time_before_after_regex: Pattern = RegExpUtility.get_safe_reg_exp(PortugueseDateTime.TimeBeforeAfterRegex)
