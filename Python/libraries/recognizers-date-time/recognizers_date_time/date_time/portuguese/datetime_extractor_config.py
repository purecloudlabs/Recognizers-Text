...
class PortugueseDateTimeExtractorConfiguration(DateTimeExtractorConfiguration):
    ...
    def __init__(self):
        super().__init__()
        self._date_point_extractor = BaseDateExtractor(PortugueseDateExtractorConfiguration())
        ...
        self.preposition_regex = RegExpUtility.get_safe_reg_exp(PortugueseDateTime.PrepositionRegex)
        ...
        self._time_of_today_after_regex = RegExpUtility.get_safe_reg_exp(PortugueseDateTime.TimeOfTodayAfterRegex)
        self._simple_time_of_today_after_regex = RegExpUtility.get_safe_reg_exp(
            PortugueseDateTime.SimpleTimeOfTodayAfterRegex
        )
        self._night_regex = RegExpUtility.get_safe_reg_exp(PortugueseDateTime.TimeOfDayRegex)
        self._time_of_today_before_regex = RegExpUtility.get_safe_reg_exp(PortugueseDateTime.TimeOfTodayBeforeRegex)
        ...
        self.connector_regex = RegExpUtility.get_safe_reg_exp(PortugueseDateTime.ConnectorRegex)
        self._number_as_time_regex = RegExpUtility.get_safe_reg_exp(PortugueseDateTime.NumberAsTimeRegex)
        self._date_number_connector_regex = RegExpUtility.get_safe_reg_exp(PortugueseDateTime.DateNumberConnectorRegex)
        self._suffix_after_regex = RegExpUtility.get_safe_reg_exp(PortugueseDateTime.SuffixAfterRegex)
        self._year_suffix = RegExpUtility.get_safe_reg_exp(PortugueseDateTime.YearSuffix)
