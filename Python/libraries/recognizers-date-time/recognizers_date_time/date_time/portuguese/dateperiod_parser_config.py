...
class PortugueseDatePeriodParserConfiguration(DatePeriodParserConfiguration):
    ...
    def __init__(self, config: BaseDateParserConfiguration):
        ...
        self._later_regex = RegExpUtility.get_safe_reg_exp(PortugueseDateTime.LaterRegex)
        self._ago_regex = RegExpUtility.get_safe_reg_exp(PortugueseDateTime.AgoRegex)
        self._date_extractor = config.date_extractor
        self._date_parser = config.date_parser
        self._duration_extractor = config.duration_extractor
        self._duration_parser = config.duration_parser
        self._month_front_between_regex = RegExpUtility.get_safe_reg_exp(PortugueseDateTime.MonthFrontBetweenRegex)
        self._between_regex = RegExpUtility.get_safe_reg_exp(PortugueseDateTime.BetweenRegex)
        self._month_front_simple_cases_regex = RegExpUtility.get_safe_reg_exp(
            PortugueseDateTime.MonthFrontSimpleCasesRegex
        )
        self._simple_cases_regex = RegExpUtility.get_safe_reg_exp(PortugueseDateTime.SimpleCasesRegex)
        self._one_word_period_regex = RegExpUtility.get_safe_reg_exp(PortugueseDateTime.OneWordPeriodRegex)
        self._month_with_year = RegExpUtility.get_safe_reg_exp(PortugueseDateTime.MonthWithYearRegex)
        self._month_num_with_year = RegExpUtility.get_safe_reg_exp(PortugueseDateTime.MonthNumWithYearRegex)
        ...
        self._week_of_month_regex = RegExpUtility.get_safe_reg_exp(PortugueseDateTime.WeekOfMonthRegex)
        self._week_of_year_regex = RegExpUtility.get_safe_reg_exp(PortugueseDateTime.WeekOfYearRegex)
        self._quarter_regex = RegExpUtility.get_safe_reg_exp(PortugueseDateTime.QuarterRegex)
        self._quarter_regex_year_front = RegExpUtility.get_safe_reg_exp(PortugueseDateTime.QuarterRegexYearFront)
        self._all_half_year_regex = RegExpUtility.get_safe_reg_exp(PortugueseDateTime.AllHalfYearRegex)
        self._season_regex = RegExpUtility.get_safe_reg_exp(PortugueseDateTime.SeasonRegex)
        self._week_of_regex = RegExpUtility.get_safe_reg_exp(PortugueseDateTime.WeekOfRegex)
        self._month_of_regex = RegExpUtility.get_safe_reg_exp(PortugueseDateTime.MonthOfRegex)
        self._which_week_regex = RegExpUtility.get_safe_reg_exp(PortugueseDateTime.WhichWeekRegex)
        ...
        self._this_prefix_regex = RegExpUtility.get_safe_reg_exp(PortugueseDateTime.ThisPrefixRegex)
        self._rest_of_date_regex = RegExpUtility.get_safe_reg_exp(PortugueseDateTime.RestOfDateRegex)
        self._later_early_period_regex = RegExpUtility.get_safe_reg_exp(PortugueseDateTime.LaterEarlyPeriodRegex)
        ...
        self._relative_regex = RegExpUtility.get_safe_reg_exp(PortugueseDateTime.RelativeRegex)
        self._decade_with_century_regex = RegExpUtility.get_safe_reg_exp(PortugueseDateTime.DecadeWithCenturyRegex)
        self._complex_dateperiod_regex = RegExpUtility.get_safe_reg_exp(PortugueseDateTime.ComplexDatePeriodRegex)
        self._relative_decade_regex = RegExpUtility.get_safe_reg_exp(PortugueseDateTime.RelativeDecadeRegex)
        self._reference_date_period_regex = RegExpUtility.get_safe_reg_exp(PortugueseDateTime.ReferenceDatePeriodRegex)
        self._less_than_regex = RegExpUtility.get_safe_reg_exp(PortugueseDateTime.LessThanRegex)
