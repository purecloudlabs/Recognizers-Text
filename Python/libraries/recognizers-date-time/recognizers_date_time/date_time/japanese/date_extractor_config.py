...
from recognizers_date_time.date_time.CJK import BaseCJKDurationExtractor, CJKDateExtractorConfiguration
...
class JapaneseDateExtractorConfiguration(CJKDateExtractorConfiguration):
    ...
    def time_clock_desc_regex(self) -> Pattern:
        return self._time_clock_desc_regex
    ...
    def __init__(self):
        ...
        self._time_clock_desc_regex = RegExpUtility.get_safe_reg_exp(JapaneseDateTime.TimeClockDescRegex)
