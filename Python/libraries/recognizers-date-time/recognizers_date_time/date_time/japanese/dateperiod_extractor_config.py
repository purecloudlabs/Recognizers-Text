...
class JapaneseDatePeriodExtractorConfiguration(DatePeriodExtractorConfiguration):
    ...
    def __init__(self):
        ...
        self._date_point_extractor = JapaneseDateExtractor()
    ...
    def get_from_token_index(self, source: str) -> MatchedIndex:
        match = self._from_prefix.search(source)
        match += self._from_suffix.search(source)
        if match:
