...
from .merged_parser_config import JapaneseMergedParserConfiguration


class JapaneseMergedParser(BaseMergedParser):
    def __init__(self):
        super().__init__(JapaneseMergedParserConfiguration(), DateTimeOptions.NONE)
    ...
    def parse(self, source: ExtractResult, reference: datetime = None) -> Optional[DateTimeParseResult]:
        ...
        # TODO When the implementation for these properties is added, uncomment these
