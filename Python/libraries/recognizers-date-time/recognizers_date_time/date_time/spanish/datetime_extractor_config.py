...
class SpanishDateTimeExtractorConfiguration(DateTimeExtractorConfiguration):
    ...
    def __init__(self):
        ...
        self._number_as_time_regex = RegExpUtility.get_safe_reg_exp(SpanishDateTime.NumberAsTimeRegex)
        self._date_number_connector_regex = RegExpUtility.get_safe_reg_exp(SpanishDateTime.DateNumberConnectorRegex)
        self._suffix_after_regex = RegExpUtility.get_safe_reg_exp(SpanishDateTime.SuffixAfterRegex)
        self._year_suffix = RegExpUtility.get_safe_reg_exp(SpanishDateTime.YearSuffix)
