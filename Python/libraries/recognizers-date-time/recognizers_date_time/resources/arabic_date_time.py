...
class ArabicDateTime:
    ...
    QuarterTokenRegex = f'^(الرُبع|ربع|الربع|وربع|والربع)'
    ThreeQuarterTokenRegex = f'^(وثلاثة أرباع|ثلاثة أرباع)'
    ToTokenRegex = f'\\b(إلا|الا|ناقص)'
    ...
    HourNumRegex = f'\\b(?<hournum>الأولى|ثمانية|الثانيه|خمسة|الخمسة|ستة|الستة|السبعة|سبعة|أربعة|الحاديه عشر|(ال)?واحدة|(ال)?ثالثة|(ال)?رابعة|(ال)?خامسة|(ال)?سادسة|(ال)?سابعة|(ال)?ثامنة|(ال)?تاسعة|(ال)?عاشرة|(ال)?حادية عشر(ة)?|الثانية(?!\\s*عشر)|(ال)?ثانية عشر(ة)?|خمسة عشر|اثنين|أحد عشر|التاسعة|تسعة|الوَاحِدَة)\\b'
    MinuteNumRegex = f'\\b((?<minnum>واحد|اثنان|ثلاثة|أربعة|خمسة|ستة|سبعة|ثمانية|تسعة|إحدى|اثنين|الثالثة|الرابعة|أربع|خمس|الخامسة|ست|السادسة|سبع|تسع|الثامنة|السابعة|ثلاث)\\b((\\s*و?\\s*)(عشرون|ثلاثون|أربعون|خمسون|خَمْسُونَ|عشرين|ثلاثين|عشر|عشرة))?\\b|(?<minnum>أَحَدَ عَشَرَ|اِثْنَا عَشَرَ|ثَلَاثَةَ عَشَرَ|أَرْبَعَةَ عَشَرَ|خَمْسَةَ عَشَرَ|سِتَّةَ عَشَرَ|سَبْعَةَ عَشَرَ|ثَمَانِيَةَ عَشَرَ|تِسْعَةَ عَشَرَ|عشرون|ثلاثون|أربعون|خمسون|خَمْسُونَ|عشرين|ثلاثين|عشر|عشرة|خمس عشرة))\\b'
    DeltaMinuteNumRegex = f'((?<deltaminnum>واحد|اثنان|ثلاثة|أربعة|خمسة|ستة|سبعة|ثمانية|تسعة|إحدى|اثنين|الثالثة|الرابعة|أربع|خمس|الخامسة|ست|السادسة|سبع|تسع|الثامنة|السابعة|ثلاث)\\b((\\s*و?\\s*)(عشرون|ثلاثون|أربعون|خمسون|خَمْسُونَ|عشرين|ثلاثين|عشر|عشرة))?\\b|(?<deltaminnum>أَحَدَ عَشَرَ|اِثْنَا عَشَرَ|ثَلَاثَةَ عَشَرَ|أَرْبَعَةَ عَشَرَ|خَمْسَةَ عَشَرَ|سِتَّةَ عَشَرَ|سَبْعَةَ عَشَرَ|ثَمَانِيَةَ عَشَرَ|تِسْعَةَ عَشَرَ|عشرون|ثلاثون|أربعون|خمسون|خَمْسُونَ|عشرين|ثلاثين|عشر|عشرة|خمس عشرة))'
    ...
    TimePrefix = f'(?<prefix>(إلا|الا|حتى|و|قبل|ناقص)?(\\s)?{LessThanOneHour})'
    ...
    NowRegex = f'\\b(?<now>الآن|حالا|في هذه اللحظة|توا|على التو)\\b'
    ...
    NowTimeRegex = f'(الآن|حالا|في هذه اللحظة|توا|على التو)'
    RecentlyTimeRegex = f'(مؤخرًا|سابقًا)'
    AsapTimeRegex = f'(في أسرع وقت ممكن)'
