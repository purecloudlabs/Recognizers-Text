...
class ModelResult(object):
    ...
    def __str__(self) -> str:
        return '{}: {} [{}, {}]'.format(self.type_name, self.text, self.start, self.end)
...
class ModelFactory(Generic[T_MODEL_OPTIONS]):
    ...
    def get_model(
        self, model_type_name: str, culture: str, fallback_to_default_culture: bool, options: T_MODEL_OPTIONS
    ) -> Model:
